...
<head>
    ...
    <link href="../public/admin/assets/jquery-easy-pie-chart/jquery.easy-pie-chart.css" rel="stylesheet" type="text/css"
          media="screen"/>
        ...
        <div id="sidebar" class="nav-collapse ">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a class="" href="index.php?c=category&a=list">لیست دسته بندی</a></li>
                        <li><a class="" href="index.php?c=category&a=add">افزودن دسته بندی جدید</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;" class="">
                    ...
                    <ul class="sub">
                        ...
                        <li><a class="" href="index.php?c=product&a=add">افزودن محصولات جدید</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;" class="">
